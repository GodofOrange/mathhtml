...
com_ephox_keurig_Keurig(); (function () {
  var $gwt_version = '2.6.1'; var $wnd = window; var $doc = $wnd.document; var $moduleName, $moduleBase; var $stats = $wnd.__gwtStatsEvent ? function (a) { $wnd.__gwtStatsEvent(a) } : null; var $strongName = '90BA12EED4B8175F02A135767FCD6360'; function A () {}
  function Z () {}
  function Wo () {}
  function ub () {}
  function uk () {}
  ...
  function qe (a, b) { var c; c = 0; while (a.length > b + c && String.fromCharCode(a[b + c]).match(/[A-Z\d]/i) != null) { ++c } return c }
  ...
  function Bl (a) { var b; b = 0; while ((b = a.indexOf('\\', b)) >= 0) { a.charCodeAt(b + 1) == 36 ? (a = wl(a, 0, b) + '$' + vl(a, ++b)) : (a = wl(a, 0, b) + vl(a, ++b)) } return a }
  ...
  function ef (a) { var b, c; if ((a.i >= a.k ? 0 : a.f[a.i]) != 64) { return false }b = a.h; a.i += 1; c = a.f[b + 1]; if (!(String.fromCharCode(c).match(/[A-Z]/i) != null) && c != 95) { return false } if (!Ed(a, 123)) { return false } if (!Ed(a, 125)) { return false }Xd(a, a.i + 1); return true }
